...
+ [Using AWS IoT SiteWise gateways](gateways-ggv2.md)
   + [Setting up AWS IoT SiteWise Edge gateways (Greengrass V2)](configure-gateway-ggv2.md)
   ...
   + [Setting up AWS IoT SiteWise gateways (Greengrass V1)](gateways-ggv1.md)
...
+ [Processing and consuming data locally](process-gateway-data-edge.md)
...
+ [Managing data ingestion](data-streams.md)
   + [Managing data streams](manage-data-streams.md)
...
+ [Managing data storage](manage-data-storage.md)
